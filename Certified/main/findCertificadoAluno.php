...
<body>
     ...
     <form class="form-horizontal" action="https://webserv.in/Certificado/function/validaFindCertificadoAluno.php" method="POST" >
          <fieldset>
          ...
          <div class="view" style="background-image: url('../library/img/LOGO HORIZONTAL.png');max-width:600px;margin:60px auto;background-size: cover; overflow: hidden; width: 350px; height: 100px;background-color: white;">   
                         ...
                         <div class="form-group col-md-6">
                           ...
                           <div class="form-group col-md-6"> 
                                   ...
                                   <input id="nasc" name="nasc" placeholder="" class="form-control input-md" type="text">
                              </div>   
                     <!--       
                              <div class="form-group col-md-6">
                                   <label for="Nome">Curso </label>
                                   <input id="curso" name="curso" placeholder="" class="form-control input-md" type="text">
                              </div>
                              -->
<!--                               <div class="form-group col-md-6">
                                   
                                   <label for="Nome"></label>
                                   <input id="turma" name="turma" placeholder="" class="form-control input-md" type="hidden">
                              ...
                              <div class="form-group col-md-6">
                                   ...
                                   <button id="pesquisar" name="pesquisar" class="btn btn-success" type="Submit">Pesquisar</button>
